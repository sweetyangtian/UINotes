...
var r = this.getBGNode(t),
    ...
    a = this,
    n = i.id;
if (r.isGroup || i.isGroup || r.isChildOfGroup || i.isChildOfGroup) if (r.isGroup || i.isGroup || !r.isChildOfGroup || i.isChildOfGroup) if (r.isGroup || i.isGroup || r.isChildOfGroup || !i.isChildOfGroup)!r.isGroup && !i.isGroup && r.isChildOfGroup && i.isChildOfGroup && (this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id), this.removeNodeTag(r.id, r._groupParentNodeId, !0), this.addNodeTag(r.id, i._groupParentNodeId, !0));
else {
...
return "bottom" == a ? n = t.rightNeighbor ? t.y + t.h + (t.rightNeighbor.y - (t.y + t.h)) / 2 : t.y + t.h + r.siblingSeparation / 2 : "top" == a && (n = t.leftNeighbor ? t.y + (t.leftNeighbor.y + t.leftNeighbor.h - t.y) / 2 : t.y - r.siblingSeparation / 2), e.push([e[e.length - 1][0], n]), e.push([
    [t.x - r.levelSeparation / 3], n]), o = e[e.length - 1][0], s = n, i.p = o, i.q = n, i.s = s, i
}, OrgChart._addPointRight = function(t, e, r, i, a) {
var n, o = e[e.length - 1][0];
return "bottom" == a ? n = t.rightNeighbor ? t.y + t.h + (t.rightNeighbor.y - (t.y + t.h)) / 2 : t.y + t.h + r.siblingSeparation / 2 : "top" == a && (n = t.leftNeighbor ? t.y + (t.leftNeighbor.y + t.leftNeighbor.h - t.y) / 2 : t.y - r.siblingSeparation / 2), e.push([e[e.length - 1][0], n]), e.push([
    [t.x + t.w + r.levelSeparation / 3], n]), o = e[e.length - 1][0], s = n, i.p = o, i.q = n, i.s = s, i
...
this._draw(!1, OrgChart.action.exporting, t, function(t) {
    var r = document.createElement("div");
    if (r.innerHTML = t, "svg" == i.ext) if (a) a(i, r.innerHTML);
    else {
...
void 0 === d && (d = -e.detail), d = Math.max(-1, Math.min(1, d)), o += -d * a, i ||
function t() {
    i = !0;
    var e = (o - l) / n;
...
var l = this;
this.config.mouseScrool == OrgChart.action.xScroll && this.bar &&
function(t, i, e) {
    var a = !1;
...
var l = this;
this.config.mouseScrool == OrgChart.action.yScroll && this.bar &&
function(t, i, e) {
    var a = !1;
